package com.apiumhub.github.domain.networkRepository.list
...
class RepositoryListServiceTest {
  ...
  private fun getOnMemoryEmptyRepositories(query: String = "") {
    ...
    every { inMemoryRepository.searchRepositories(query) } returns Observable.just(RepositorySearchDto(null, null, emptyList()))
