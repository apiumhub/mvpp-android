...
import com.apiumhub.github.details.RepositoryDetailsRepository
import com.apiumhub.github.core.domain.common.entity.*
import com.apiumhub.github.core.domain.entity.*
import io.reactivex.Observable
import java.util.concurrent.TimeUnit

class MockGithubRepository: RepositoryDetailsRepository {

    private val someOwner = RepositoryOwner(
        "someLogin",
        1,
        "http://someAvatarUrl.domain",
        "http://someUrl.domain"
    )
    ...
    private val someRepositorySearchResult: RepositorySearchDto =
        RepositorySearchDto(3, false, someRepositoryList)
